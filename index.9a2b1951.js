 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const x="9.13.0";function k(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const r=Object.assign({name:d,automaticDataCollectionEnabled:!1},t),o=r.name;if("string"!=typeof o||!o)throw _.create("bad-app-name",{appName:String(o)});if(n||(n=(0,s.getDefaultAppConfig)()),!n)throw _.create("no-options");const a=p.get(o);if(a){if((0,s.deepEqual)(n,a.options)&&(0,s.deepEqual)(r,a.config))return a;throw _.create("duplicate-app",{appName:o})}const l=new(0,i.ComponentContainer)(o);for(const e of m.values())l.addComponent(e);const c=new w(n,r,l);return p.set(o,c),c}function C(e="[DEFAULT]"){const t=p.get(e);if(!t&&e===d)return k();if(!t)throw _.create("no-app",{appName:e});return t}function E(e,t,n){var r;let o=null!==(r=f[e])&&void 0!==r?r:e;n&&(o+=`-${n}`);const s=o.match(/\s|\//),a=t.match(/\s|\//);if(s||a){const e=[`Unable to register library "${o}" with version "${t}":`];return s&&e.push(`library name "${o}" contains illegal characters (whitespace or "/")`),s&&a&&e.push("and"),a&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void h.warn(e.join(" "))}y(new(0,i.Component)(`${o}-version`,(()=>({library:o,version:t})),"VERSION"))}
/**
 * @license
 ...
 * limitations under the License.
 */
const I="firebase-heartbeat-store";let T=null;function S(){return T||(T=(0,a.openDB)("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(I)}}).catch((e=>{throw _.create("idb-open",{originalErrorMessage:e.message})}))),T}async function N(e,t){var n;try{const n=(await S()).transaction(I,"readwrite"),i=n.objectStore(I);return await i.put(t,R(e)),n.done}catch(e){if(e instanceof s.FirebaseError)h.warn(e.message);else{const t=_.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});h.warn(t.message)}}}function R(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function re(e){return e&&e._delegate?e._delegate:e}})),o.register("7vF8m",(function(t,n){e(t.exports,"LogLevel",(function(){return r})),e(t.exports,"Logger",(function(){return u})),e(t.exports,"setLogLevel",(function(){return h})),e(t.exports,"setUserLogHandler",(function(){return d}));
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class vi{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function bi(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],o=r.getPath();null===n||Te(o,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:o}),n.events.push(r)}n&&e.eventLists_.push(n)}function _i(e,t,n){bi(e,n),wi(e,(e=>Se(e,t)||Se(t,e)))}function wi(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(xi(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function xi(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();w&&C("event: "+n.toString()),q(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */or=i.SDK_VERSION,h=or,(0,i._registerComponent)(new(0,r.Component)("database",((e,{instanceIdentifier:t})=>tr(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),(0,i.registerVersion)(c,u,rr),(0,i.registerVersion)(c,u,"esm2017")})),o("kyEFX").register(JSON.parse('{"5fZck":"index.9a2b1951.js","45HKR":"coming_soon.265f69e2.jpg","9v6fF":"symbol-defs.0f67bb5c.svg","lex4W":"iryna-bodnaryuk.bbf051c8.jpg","hX4l8":"vladyslav-gladyshko.e078bebf.jpg","1SX62":"yuriy_kulinichenko.e933625b.jpg","3Pm6E":"aleksandr-kurzhiy.4dfb5809.jpg","jJ9bP":"andrey-dymov.a61bb4c5.jpg","1BO4e":"rustem-dzhuraiev.5ae846f9.jpg","9xbrc":"vladislav-zavertaylo.96be176b.jpg","ibi2F":"vladyslav.b21ae48c.jpg","m09zo":"roman-tunkiv.8722f996.jpg","kqDX1":"serhiy-nazarov.8f39fd73.jpg"}'));
//# sourceMappingURL=index.9a2b1951.js.map
